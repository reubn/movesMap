            ...
            makePolylines: function (chart) {
                ...
                for (var i = 0; i < chart.data.chart.paths.length; i++) {
                    if (chart.data.chart.paths[i] !== null) {
                        ...
                        chart.data.processedPaths[i].setMap(chart.graph);
                ...
                chart.other.dateSliderFrom.addEventListener('mouseup', function () {
                    ...
                    chart.data.processedPaths.map(function (a) {
                        //console.log(a.type + " " + thisOne.type);
                        if ((a.startTime.isAfter(chart.other.dateSlider.rangeObj.from.date) || a.startTime.isSame(chart.other.dateSlider.rangeObj.from.date, 'day')) && (a.endTime.isBefore(chart.other.dateSlider.rangeObj.to.date) || a.endTime.isSame(chart.other.dateSlider.rangeObj.to.date, 'day'))) {
                            a.setMap(chart.graph);
                        } else {
                            a.setMap(null);
                        }
